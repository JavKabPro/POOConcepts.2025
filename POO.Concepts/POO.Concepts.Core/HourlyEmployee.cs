...
public class HourlyEmployee : Employee
{
    ...
    private decimal ValidateHourValue(decimal hourValue)  //separado de la propiedad pública
    {
        if (hourValue <= 0)
        {
    ...
    private float ValidateWorkingHours(float workingHours)  //separado de la propiedad pública
    {
        if (workingHours <= 0)
        {
